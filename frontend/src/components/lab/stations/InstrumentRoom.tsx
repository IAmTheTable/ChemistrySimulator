  ...
  return (
    <StationShell wallColor="#2d3142" showShelf={false}>
      ...
      <InteractiveTool
        ...
        position={[-1.4, 0.28, -0.95]}
        hitboxSize={[0.75, 0.45, 0.55]}
      ...
      <InteractiveTool
        ...
        onClick={handleHPLC}
        position={[-0.4, 0.22, -0.97]}
        hitboxSize={[0.6, 0.32, 0.5]}
        labelOffset={[0, 0.3, 0]}
      >
        <mesh castShadow>
        ...
        {/* Small knobs row */}
        {([-0.15, 0, 0.15] as number[]).map((x, i) => (
          <mesh key={i} position={[x, -0.09, 0.225]}>
      ...
      <InteractiveTool
        ...
        onClick={handleUVVis}
        position={[0.55, 0.2, -0.97]}
        hitboxSize={[0.55, 0.3, 0.48]}
        labelOffset={[0, 0.3, 0]}
      >
        <mesh castShadow>
      ...
      <InteractiveTool
        ...
        onClick={handleNMR}
        position={[1.45, 0.35, -0.93]}
        hitboxSize={[0.6, 0.6, 0.55]}
        labelOffset={[0, 0.4, 0]}
      >
        <mesh castShadow>
        ...
        {([0, 1, 2] as number[]).map((i) => (
          <mesh key={i} position={[-0.27, 0.17 - i * 0.08, 0.255]}>
